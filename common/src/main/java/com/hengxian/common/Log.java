...
public class Log {
    ...
    public static void i(String tag, String content, Throwable tr) {
        if (BuildConfig.DEBUG) {
            ...
            if (tr == null) {
                android.util.Log.i(TextUtils.isEmpty(tag) ? TAG : tag, content);
            } else {
                android.util.Log.i(TextUtils.isEmpty(tag) ? TAG : tag, content, tr);
            }
        }
    }
    ...
    public static void d(String tag, String content, Throwable tr) {
        if (BuildConfig.DEBUG) {
            ...
            if (tr == null) {
                android.util.Log.d(TextUtils.isEmpty(tag) ? TAG : tag, content);
            } else {
                android.util.Log.d(TextUtils.isEmpty(tag) ? TAG : tag, content, null);
            }
        }
    }
    ...
    public static void e(String tag, String content, Throwable tr) {
        if (BuildConfig.DEBUG) {
            ...
            if (tr == null) {
                android.util.Log.e(TextUtils.isEmpty(tag) ? TAG : tag, content);
            } else {
                android.util.Log.e(TextUtils.isEmpty(tag) ? TAG : tag, content, tr);
            }
        }
    }
    ...
    public static void w(String tag, String content, Throwable tr) {
        if (BuildConfig.DEBUG) {
            ...
            if (tr == null) {
                android.util.Log.w(TextUtils.isEmpty(tag) ? TAG : tag, content);
            } else {
                android.util.Log.w(TextUtils.isEmpty(tag) ? TAG : tag, content, tr);
            }
        }
    }
    ...
    public static void v(String tag, String content, Throwable tr) {
        if (BuildConfig.DEBUG) {
            ...
            if (tr == null) {
                android.util.Log.v(TextUtils.isEmpty(tag) ? TAG : tag, content);
            } else {
                android.util.Log.v(TextUtils.isEmpty(tag) ? TAG : tag, content, tr);
            }
        }
    }
