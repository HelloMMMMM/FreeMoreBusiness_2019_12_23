...
/**
 * function:根据银行卡号获取银行名称
 * author: frj
 * modify date: 2019/4/20
 */
public class VerificationPerson
{
    private String totalBankcode;//银行卡号
    private String bankName;//银行名字
    private String bankId;//银行编码
    private String cardType;//银行卡类型

    public VerificationPerson(String totalBankcode)
    {
