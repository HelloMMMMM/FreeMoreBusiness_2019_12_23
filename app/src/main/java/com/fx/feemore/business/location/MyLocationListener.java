package com.fx.feemore.business.location;
...
public class MyLocationListener implements BDLocationListener {
    ...
    public void onReceiveLocation(BDLocation location) {
        ...
        if (!Const.CITY_CODE.equals(location.getCityCode())) {
            Const.CITY_CODE = location.getCityCode();
            BaseComponent baseComponent = BaseInjector.init(AppContext.instance, new BaseConfig());
            DaggerAppComponent.builder()
                    .baseComponent(baseComponent)
                    .build().inject(AppContext.instance);
        }
    }
}
