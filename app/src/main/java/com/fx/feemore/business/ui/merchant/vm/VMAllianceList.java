...
/**
 * function:商家联盟列表ViewModel
 * author: frj
 * modify date: 2019/3/7
 */
public class VMAllianceList extends ViewModel
{
    ...
    @Inject
    public VMAllianceList(DataSource dataSource)
    {
    ...
    {
        dataSource.getAlliances(storeId, page, pageSize, "").subscribe(new ApiCallback<List<AllianceBean>>()
        {
            @Override
